...
export async function fetchStats(accountId: string, period: TimePeriod): Promise<StatsData> {
  ...
  try {
    ...
    logger.info('导航到快手数据中心...');

    await page.goto(KUAISHOU_URLS.statsOverview, { waitUntil: 'domcontentloaded' });
